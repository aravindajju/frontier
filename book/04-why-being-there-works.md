...
Every one of these failures is observable, most of them in the four numbers of chapter 14. That is by design. The next chapter surveys the method built on these claims; the part that follows shows it in operation, one practice at a time. None of it asks to be believed. All of it asks to be measured.
